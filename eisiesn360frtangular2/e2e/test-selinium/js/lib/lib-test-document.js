...
const LIST_NAME = "Categories"

export async function addCategoryDocument(driver, num) {
    let name = "test-act-" + num

    let fct = "addCategoryDocument " + name
    ...
    await utils.clickElement(driver, "addCategoryDocument");
    await driver.sleep(1000);
...
export async function updateCategoryDocument(driver, activityName) {

    let fct = "updateCategoryDocument " + activityName
...
export async function deleteCategoryDocument(driver, activityName) {

    let fct = "deleteCategoryDocument " + activityName
